        ...
        <!-- Sidebar End -->
                ...
                <div class="content">
                    ...
                    <div class="container-fluid pt-4 px-4">
                        <div class="row g-4">
                            <div class="col-sm-120col-md-20col-xl-4">
                                <div class="h-100 bg-light rounded p-4">
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <h6 class="mb-0">History Laporan</h6>
                                    </div>
                                    <div class="d-flex align-items-center border-bottom py-3">
                                        ...
                                        <div class="w-100 ms-3">
                                            <div class="d-flex w-100 justify-content-between">
                                                ...
                                                <small>20 Agustus 2022</small>
                                            </div>
                                            <span>Pengajuan Dana Pembangunan Jembatan</span>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center border-bottom py-3">
                                        <img class="rounded-circle flex-shrink-0" src="img/user.jpg" alt="" style="width: 40px; height: 40px;">
                                        <div class="w-100 ms-3">
                                            <div class="d-flex w-100 justify-content-between">
                                                <h6 class="mb-0">Laporan Anggaran</h6>
                                                <small>12 Januari 2022</small>
                                            </div>
                                            <span>Pengajuan Dana Perbaikan Selokan</span>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center border-bottom py-3">
                                        <img class="rounded-circle flex-shrink-0" src="img/user.jpg" alt="" style="width: 40px; height: 40px;">
                                        <div class="w-100 ms-3">
                                            <div class="d-flex w-100 justify-content-between">
                                                <h6 class="mb-0">Laporan Proposal</h6>
                                                <small>1 Mei 2021</small>
                                            </div>
                                            <span>Laporan Pengajuan Pembuatan Rumah Baca</span>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center pt-3">
                                        ...
                                        <div class="w-100 ms-3">
                                            <div class="d-flex w-100 justify-content-between">
                                                <h6 class="mb-0">Laporan Proposal</h6>
                                                <small>13 Juni 2021</small>
                                            </div>
                                            <span>Pengajuan Rancangan Pembuatan Bank Sampah.</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                                <a href="#" class="dropdown-item">
                                    <div class="d-flex align-items-center">
                                        <img class="rounded-circle" src="img/user.jpg" alt="" style="width: 40px; height: 40px;">
                                        <div class="ms-2">
                                            <h6 class="fw-normal mb-0">Laporan Proposal</h6>
                                            <small>4 April 2020</small>
                                            <span>Pengajuan Rancangan Pembangunan Rumah Belajar</span>
                                        </div>
                                    </div>
                                </a>
