        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0">Chloe Kiehls</h6>
                        <span>Admin</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    <a href="/Admin/Dashboard" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="/User/LaporanSaya" class="nav-item nav-link "><i class="fa fa-th me-2"></i>Edit Laporan</a>
                    <a href="/userHistory" class="nav-item nav-link "><i class="fa fa-th me-2"></i>Edit User</a>
                    <a href="form.html" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Edit Lokasi</a>
                    </div>
                </div>
            </nav>
        </div>
